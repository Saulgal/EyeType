  ...
  const languages = {
    en: {
      ...
      labels: {
        ...
        calibrationInstructions: 'Point your face toward each dot, then blink 3× rapidly or hold eyes closed 1s to confirm.',
    ...
    'pt-BR': {
      ...
      labels: {
        ...
        calibrationInstructions: 'Aponte seu rosto para cada ponto e pisque 3× rapidamente ou mantenha os olhos fechados por 1s para confirmar.',
    ...
    es: {
      ...
      labels: {
        ...
        calibrationInstructions: 'Apunte su rostro hacia cada punto y parpadee 3× rápidamente o mantenga los ojos cerrados 1s para confirmar.',
